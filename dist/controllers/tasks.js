...
exports.updateTask = exports.saveTask = exports.home = exports.getTasks = exports.getTaskCount = exports.getTask = exports.deleteTask = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            db = _context.sent;
            _context.next = 5;
            return db.query('SELECT * FROM tasks WHERE id = ?', [req.params.id]);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            db = _context3.sent;
            _context3.next = 5;
            return db.query('SELECT COUNT(*) FROM tasks');
...
var deleteTask = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var db, _yield$db$query9, _yield$db$query10, results;
